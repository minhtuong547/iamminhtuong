...
if(isset($_GET['xoa'])){
  $id_get = $_GET['xoa'];
 echo '<meta http-equiv="refresh" content="1;url=/taivip_2004/pages/bansourcecode/edittheloaiz.php">';
                  ...
                  while($row = mysqli_fetch_assoc($query)){
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="/taivip_2004/pages/bansourcecode/edittheloai2.php?id=<?php echo $row['id']; ?>"><button class="btn btn-sm btn-success">Edit</button></a>

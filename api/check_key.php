...
<img alt='profile card' src="https://i.imgur.com/6hy5huD.jpg">
</div>
...
text="ĐINH MINH TƯỚNG";
string2array(text);
divserzeugen();
</script>
</center>
 </br>       
<h3 align="center"> HIIIII CÁC EM ANH LÀ DinhMinhTuongDZAIVKL ĐÂY =))</h3>
...
<span style="font-size:20px">
	<h3 align="center">SAO CHÉP KEY FREE Ở BÊN DƯỚI</h3>
<center>Hôm Nay Ngày [<?=date('d-m-Y');?>]</span>
<center>API Key Là:
<br><b><?=$_GET['key'];?></b><br><br></center></span>
...
<div class='profile-card-social'>
                        <a class='profile-card-social__item Fanfage' href='https://www.facebook.com/DoMoTo.IT' target='_blank'>
                            <span class='icon-font'>
                                <svg class='icon'><use xlink:href='#icon-facebook'/></svg>
                            </span>
                        </a>
                        <a class='profile-card-social__item tik tok' href='https://github.com/minhtuong547 ' target='_blank'>
                            <span class='icon-font'>
                                <svg class='icon'><use xlink:href='#icon-github'/></svg>
                            </span>
                        </a>
                        <a class='profile-card-social__item link' href='https://iamminhtuong.vn' target='_blank'>
                            <span class='icon-font'>

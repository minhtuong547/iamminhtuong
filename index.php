...
<!DOCTYPE html>
    ...
    <head>
        ...
        <meta name="description" content="Đinh Minh Tướng Thông Tin Cá Nhân" />
        <meta name="keywords" content="dinhminhtuong, dinhminhtuong vn , vdinh9 minh tướng thông tin cá nhân, dinhminhtuong vi en , edinh9 minh tướng  vi en , thông tin cá nhân đinh minh tướng , thông tin đinh minh tướng , đinh minh tướng là ai, đinh minh tướng 2010, đinh minh tướng 1906, minhtuong547 , lat" />
        <meta property="og:title" content="Đinh Minh Tướng Thông Tin Cá Nhân" />
        <meta property="og:type" content="Đinh Minh Tướng Thông Tin Cá Nhân" />
        <meta property="og:url" content="https://iamminhtuong.vn" />
        <meta property="og:image" content="https://graph.facebook.com/100084373309534/picture?width=200&height=200&access_token=6628568379|c1e620fa708a1d5696fb991c1bde5662" />
        <meta property="og:description" content="Đinh Minh Tướng Thông Tin Cá Nhân" />
        <meta property="og:site_name" content="Đinh Minh Tướng Thông Tin Cá Nhân" />
        <meta property="article:section" content="Đinh Minh Tướng Thông Tin Cá Nhân" />
        <meta property="article:tag" content="leanhtuan, leanhtuan info, Đinh Minh Tướng thông tin cá nhân, leanhtuaninfo, Đinh Minh Tướng info, thông tin cá nhân Đinh Minh Tướng, thông tin Đinh Minh Tướng, Đinh Minh Tướng là ai, Đinh Minh Tướng 2007, Đinh Minh Tướng 1906, leanhtuan19, lat" />
        <script type="text/javascript" src="/assets/js/head.js?1700221682"></script>
        <!--=============== FAVICON ===============-->
        <link rel="shortcut icon" href="https://i.imgur.com/jS4tyRI.png" type="image/x-icon">
        ...
        <link rel="stylesheet" href="/assets/css/hieuung.css">
        ...
        <title>Đinh Minh Tướng Thông Tin Cá Nhân</title>
        <!--=============== HEADER ===============-->
              ...
              <div class="profile__data">
                  <div class="profile__border">
                      <div class="profile__perfil">
                          ...
                          <img src="https://graph.facebook.com/10160840728970482/picture?width=200&height=200&access_token=6628568379|c1e620fa708a1d5696fb991c1bde5662" alt="" style="width: 540px; height: 120px;">
                        </div>
                    </div>

                    <h2 class="profile__name">Đinh Minh Tướng<i data-visualcompletion="css-img" aria-label="Tài khoản đã xác minh" class="" role="img" style="background-image: url(&quot;https://static.xx.fbcdn.net/rsrc.php/v3/yf/r/AOac759jBKZ.png&quot;); background-position: -168px -153px; background-size: auto; width: -5px; height: 16px; background-repeat: no-repeat; display: inline-block;"></i></h2>

                    <h3 class="profile__profession">Coder - Developer</h3>

                    <ul class="profile__social">
                        <a href="https://www.facebook.com/DoMoTo.IT" target="_blank" class="profile__social-link">
                            <i class="ri-facebook-fill"></i>
                        </a>
                        <a href="https://zalo.me/0376017413" target="_blank" class="profile__social-link">
                            <i class="ri-question-answer-fill"></i>
                        </a>
                        <a href="https://github.com/minhtuong547 " target="_blank" class="profile__social-link">
                ...
                <div class="profile__info grid">
                    <div class="profile__info-group">
                        <h3 class="profile__info-number">200*</h3>
                        <p class="profile__info-description">
                            Năm sinh<br> 
                        </p>
                    </div>
                    <div class="profile__info-group">
                        <h3 class="profile__info-number">196M+</h3>
                        <p class="profile__info-description">
                            Follow
                        </p>
                    </div>
                    <div class="profile__info-group">
                        <h3 class="profile__info-number">Bình Phước</h3>
                        <p class="profile__info-description">Vị Trí <br> </p>
                    </div>
                </div>

                <div class="profile__buttons">
                    <!-- Insert your CV -->
                     <a href="booster/thongtinthanhtoan" class="button">
                        Thông Tin Thanh Toán<i class="ri-bank-line"></i>
                    <a href="booster" class="button">
                        Booster <i class="ri-arrow-up-line"></i>
                    </a>
                    

                    <div class="profile__buttons-small">
                        <!-- Insert a real number plus country code -->
                        <a href="https://api.whatsapp.com/send?phone=0376017413&text=Hello, more information!" target="_blank" class="button button__small button__gray">
                            <i class="ri-whatsapp-line"></i>
                        </a>
                        <!-- Insert your brand name or profile -->
                        <a href="https://m.me/553910481" target="_blank" class="button button__small button__gray">
                ...
                <div class="filters__sections">
                    ...
                    <div class="projects__content grid filters__active" data-content id="projects">
                        ...
                        <article class="projects__card">
                            <img src="https://i.imgur.com/hcT9vYu.png" alt="" class="projects__img">

                            <div class="projects__modal">
                                <div>
                                    <span class="projects__subtitle">Server Website</span>
                                    <h3 class="projects__title">SERVER DDOS V3</h3>
                                     <a href="https://iamminhtuong.vn/toolddos/" class="projects__button button button__small">
                       ...
                       <article class="projects__card">
                            <img src="https://i.imgur.com/h4sunec.png" alt="" class="projects__img">

                            <div class="projects__modal">
                                <div>
                                    <span class="projects__subtitle">Website</span>
                                    <h3 class="projects__title">Tạo Thông Tin Thanh Toán</h3>
                                    <a href="https://iamminhtuong.vn/website/" class="projects__button button button__small">
                                        <i class="ri-eye-fill"></i>
                                    </a>
                                </div>
                            </div>
              ...
              new Vue({
                ...
                data() {
                  return {
                    ...
                    tracks:[{
                        name: "Đinh Minh Tướng",
                        artist: "10 Ngàn Năm (Speed up)",
                        cover: "assets/img/img1.jpg",
                        source: "https://docs.google.com/uc?id=1392Xh4TOuqz6KAHalDGIMo8C40xBLfQQ",
                        url: "https://docs.google.com/uc?id=1392Xh4TOuqz6KAHalDGIMo8C40xBLfQQ",
                        favorited: false
                      },
                      {
                        name: "Đinh Minh Tướng",
                        artist: "Sài Gòn Simple Love",
                        cover: "assets/img/img2.jpg",
                        source: "https://docs.google.com/uc?id=1fLH_n4HVTBwVgM2ESkNOeuqv-01VGUNW",
                        url: "https://docs.google.com/uc?id=1fLH_n4HVTBwVgM2ESkNOeuqv-01VGUNW",
                        favorited: false
                      },
                      {
                        name: "Đinh Minh Tướng",
                        artist: "3107 id072019",
                        cover: "assets/img/img3.jpg",
                        source: "https://docs.google.com/uc?id=1XFXVRz7mld9tccCkyNYrRl3_Ta5cBg4L",
                        url: "https://docs.google.com/uc?id=1XFXVRz7mld9tccCkyNYrRl3_Ta5cBg4L",
                        favorited: false
                      },
                      {
                        name: "Đinh Minh Tướng",
                        ...
                        source: "https://docs.google.com/uc?id=1Buc_AXtf8kMRQAlQcp738reaD8rdU6k2",
                        url: "https://docs.google.com/uc?id=1Buc_AXtf8kMRQAlQcp738reaD8rdU6k2",
                        favorited: false
                      },
                      {
                        name: "Đinh Minh Tướng",
                        artist: "Trước khi em tồn tại",
                        cover: "assets/img/img5.jpg",
                        source: "https://docs.google.com/uc?id=1OdZw_s57wUin3WkQLGlEMLHeYFcsMtz0",
                        url: "https://docs.google.com/uc?id=1OdZw_s57wUin3WkQLGlEMLHeYFcsMtz0",
                        favorited: false
                      },
                      ],
...
<footer class="footer container">
            <span class="footer__copy">
                &#169; <a href='https://www.facebook.com/DoMoTo.IT'> Đinh Minh Tướng </a> COPYRIGHT
            </span>
        </footer>
      ...
      //<![CDATA[
      // Say Hi to Adblock
      function downloadJSAtOnload(){var e=document.createElement("script");e.src="https://iamminhtuong.vn/js/blockads.js",document.body.appendChild(e)}window.addEventListener?window.addEventListener("load",downloadJSAtOnload,!1):window.attachEvent?window.attachEvent("onload",downloadJSAtOnload):window.onload=downloadJSAtOnload;
      //]]>
      </script>

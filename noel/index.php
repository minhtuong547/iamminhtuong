  ...
  <body>
    ...
    <div id="main">
      ...
      <div id="Container-Jav">
       ...
       Minh Tướng <img class="girl-tick" src="./_static/img/banhradiem.webp?<?=bin2hex(random_bytes(5));?>">
          </div>
        </div>
        ...
        <div class="inner-glow-container">
          ...
          <div class="text-container">
     Kiều Tiên <img class="girl-tick" src="./_static/img/dutvodianh.webp?<?=bin2hex(random_bytes(5));?>">
          </div>
        </div>
      </div>
